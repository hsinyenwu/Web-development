...
* Add "navbar-fixed-top" to \<nav> (i.e. \<nav class="navbar navbar-inverse navbar-fixed-top">)
...
```
We want navbar to stay on top (not moving away when you scroll down the page).  
